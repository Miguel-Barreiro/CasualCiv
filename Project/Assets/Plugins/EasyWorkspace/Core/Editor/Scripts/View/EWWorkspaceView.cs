...
namespace EasyWorkspace
{
    ...
    [UxmlElement]
#endif
    public partial class EWWorkspaceView : VisualElement
    {
#if !UNITY_6000_0_OR_NEWER
        ...
        public EWWindow Window => _window;
        ...
        public void UpdateTabs()
        {
            ...
            for (int i = 0; i < Mathf.Max(openedWorkspaces.Length, currentTabs.Length); i++)
            {
                if (i < openedWorkspaces.Length)
                {
                    ...
                    tab.Initialize(this, openedWorkspaces[i], openedWorkspaces[i].Opened);
        ...
        public void SetWindow(EWWindow window)
        {
            _window = window;
        }
